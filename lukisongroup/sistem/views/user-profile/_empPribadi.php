<div class="col-xs-12 col-md-9 col-lg-9" style="font-family: tahoma ;font-size: 10pt;">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 alert alert-info">
			Your Personal Info is only 85% complete, to enjoy full feaures you have to complete it 100%.
			<div style="height:4px">
				<div class="col-sm-12 col-md-12 col-lg-12 progress-bar progress-bar-striped active progress-bar-danger"  role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 85%;">
