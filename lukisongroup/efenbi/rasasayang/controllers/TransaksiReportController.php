...
class TransaksiReportController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->searchTransReportHeader(Yii::$app->request->queryParams);
		// print_r($dataProvider1->getModels());
		// die();
		
		
        //$dataProvider = $searchModel->searchTransReportDetail(Yii::$app->request->queryParams);
