...
class Transaksi extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ITEM_DISCOUNT_TIME' => Yii::t('app', 'DISCOUNT TIME'),
        ];
    }
	
	//JOIN TABLE TYPE TRANSAKSI
	public function getTypeTbl()
	{
		return $this->hasOne(TransaksiType::className(), ['ID' => 'TRANS_TYPE']);
	}
	
	//Attribute TYPE NM
	public function getTypeNm()
	{
		return $this->typeTbl->TYPE_NM;
	}	
}
