 ...
 */
class Authmodel1 extends Model
{
      public $empNm;
      public $NotuID;
	  public $password;
	...
	*/
	public function auth1_saved(){
		if ($this->validate()) {
			   ...
			   $NotulenModul->SIGN_STT1 = 1;
			   $NotulenModul->SIG1_ID = $this->getProfile()->EMP_ID;
			   $NotulenModul->SIG1_NM = $this->getProfile()->EMP_NM . ' ' . $this->getProfile()->EMP_NM_BLK;
			   $NotulenModul->save();
