...
/**
 * NotulenModulSearch represents the model behind the search form about `lukisongroup\widget\models\NotulenModul`.
 */
class NotulenModulSearch extends NotulenModul
{
    /**
     * @inheritdoc
     */
