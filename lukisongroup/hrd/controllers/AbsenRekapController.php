...
class AbsenRekapController extends Controller
{
    ...
    public function actionIndex()
    {
		...
		/*REKAP ADMIN*/
		//Field Label
		$searchModelField = new PersonallogSearch();
		$dataProviderField = $searchModelField->fieldTglRange();
		//Value row
		$searchModelRow = new PersonallogSearch();
		$dataProviderRow = $searchModelRow->searchTglRange(Yii::$app->request->queryParams);
        return $this->render('index', [
			...
			'dataProviderRow'=>$dataProviderRow
        ]);
    }
