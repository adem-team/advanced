...
class Customer extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['CUST_KD', 'CUST_NM', 'ALAMAT', 'PIC', 'EMAIL', 'WEBSITE', 'NOTE', 'STATUS', 'NPWP', 'CREATED_BY', 'CREATED_AT','DATA_ALL'], 'required'],
            [['CUST_NM','NOTE'],'match','pattern'=> '/^[A-Za-z0-9_ ]+$/u','message'=> 'only [a-zA-Z0-9_].'],
            [['ALAMAT', 'NOTE'], 'string'],
