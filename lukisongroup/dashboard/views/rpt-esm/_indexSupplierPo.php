...
ChartAsset::register($this);
	...
	$mscolumn3dSupplierPo= Chart::Widget([
		'urlSource'=> url::base().'/dashboard/rpt-esm-chart-salesmd/visit-nka-po',
		...
		'renderid'=>'mscolumn3d-Supplier-po-all',						//unix name render
		'autoRender'=>true,
		'width'=>'100%',
		'height'=>'500%',
		'chartOption'=>[				
