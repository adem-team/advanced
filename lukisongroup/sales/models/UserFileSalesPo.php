 ...
 */
 ...
 Yii::$app->params['uploadPath'] = '/var/www/backup/ExternalData/import_salespo/';
 Yii::$app->params['uploadUrl'] = '/var/www/backup/ExternalData/default_format/';
class UserFileSalesPo extends \yii\db\ActiveRecord
{
    ...
    public function getImageUrl()
    {
        ...
        $FILE_NM = isset($this->FILE_NM) ? $this->FILE_NM : 'default_import_salespo.xlsx';
	...
	public function uploadFile() {
        ...
        $this->FILE_NM = 'stock_salespo_'.date('Y-m-d-His').".{$ext}"; //$image->name;//Yii::$app->security->generateRandomString().".{$ext}";
