 ...
 */
 ...
 Yii::$app->params['uploadPath'] = '/var/www/backup/ExternalData/import_gudang/';
 Yii::$app->params['uploadUrl'] = '/var/www/backup/ExternalData/default_format/';
class UserFileGudang extends \yii\db\ActiveRecord
{
	...
	public function uploadFile() {
        ...
        $this->FILE_NM = 'stock_gudang_'.date('Y-m-d-His').".{$ext}"; //$image->name;//Yii::$app->security->generateRandomString().".{$ext}";
