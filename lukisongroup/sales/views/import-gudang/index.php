...
/**
	...
	*/
	...
	$items=[
		[
			'label'=>'<i class="fa fa-map-marker fa-2x"></i> Import Gudang','content'=>$_indexImportGudang,
			'active'=>$tab0,
		],
		[
			'label'=>'<i class="fa fa-list-ol fa-2x"></i> Latest Import Data','content'=>$_indexGudangLastImport,
			'active'=>$tab1,
		], 	
		[
			'label'=>'<i class="fa fa-list-ol fa-2x"></i> Wekly Data','content'=>$_indexGudangWeekly,
			'active'=>$tab1,
		], 	
	];
