...
namespace lukisongroup\backs\models;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use lukisongroup\backs\models\Posting;

/**
 * PostingSearch represents the model behind the search form about `lukisongroup\backs\models\Posting`.
 */
