...
use lukisongroup\master\models\Barang;
	...
	//print_r($aryProviderDetailSellIN);
	$headColomnEvent=[
...
?>
	<div style="font-family:tahoma, arial, sans-serif;font-size:9pt;text-align:center;color:red"><b>Detail - SELL.IN</b></div>
	<?=$gvSellIn?>