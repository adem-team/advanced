					...
					<td>
						<table style="font-size: 12px; font-family: Verdana, sans-serif;">
							...
							<tr>
								...
								<td style="color:black; background:white;text-align:left">
									<?php echo $data->SIG1_TGL!=''?$data->SIG1_TGL:'none'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
								...
								<td style="color:black; background:white;text-align:left">
									<?php echo $data->SIG1_NM!=''?$data->SIG1_NM:'none'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
								...
								<td style="color:black; background:white;text-align:left">
									<?php echo $data->SIG2_TGL!=''?$data->SIG2_TGL:'none'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
								...
								<td style="color:black; background:white;text-align:left">
									<?php echo $data->SIG2_SVGBASE64!=''?$data->SIG2_NM:'none'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
								...
								<td style="color:black; background:white;text-align:left">
									<?php echo $data->SIG3_TGL!=''?$data->SIG3_TGL:'none'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
								...
								<td style="color:black; background:white;text-align:left">
									<?php echo $data->SIG2_SVGBASE64!=''?$data->SIG3_NM:'none'; ?>
								</td>
							</tr>
						</table>
					</td>
