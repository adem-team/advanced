		...
		<div class="box direct-chat direct-chat">
		 <!-- box-header -->
			<div class="box-header with-border" >
				<h3 class="box-title" style="font-family:tahoma, arial, sans-serif;font-size:10pt;text-align:center;color:blue" ><?php echo "<b>CUSTOMER DETAIL</b>";?></h3>
					...
					<!-- Message. Default to the left -->
						 <div class="raw">
							<div class="col-sm-12 col-md-12 col-lg-12" style="font-family:tahoma, arial, sans-serif;font-size:9pt">
								<?php
									$dvInfoCustomer=$this->render('_expand1CustDetail',['modelCust'=>$modelCust]);													
									$dvImgCustomer=$this->render('_expand1CustImage',['modelCustImg'=>$modelCustImg]);																						
								?>
								<?=$dvInfoCustomer?>
								<?=$dvImgCustomer?>
							</div>
