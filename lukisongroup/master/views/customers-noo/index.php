...
$tabcustomersData = \kartik\grid\GridView::widget([
  ...
  'filterRowOptions'=>['style'=>'background-color:rgba(255, 154, 48, 1); align:center'],
  // 'floatHeader'=>true,
    ...
    [
      ...
      'headerOptions'=>[
        'style'=>[
          ...
          'font-size'=>'9pt',
          'background-color'=>'rgba(255, 154, 48, 1)',
        ]
      ],
      'contentOptions'=>[
        'style'=>[
  ...
  'panel'=>[
	...
	'heading'=>'<i class="fa fa fa-tags fa-1x"></i> NOO - New Customer',
    'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app', 'Create  ',
            ['modelClass' => 'Customers',]),'/master/customers-noo/createcustomers',[
                              'data-toggle'=>"modal",
                              'id'=>'modcus',
			...
			Html::a('<i class="fa fa-history "></i> '.Yii::t('app', 'Refresh',
					['modelClass' => 'Customers1',]),'/master/customers-noo',[
									   'id'=>'refresh-cust-erp',
									   'data-pjax' => 0,
...
$(document).on('click', '[data-toggle-delete-erp]', function(e){
  ...
  $.ajax({
           url: '/master/customers-noo/delete-erp',
           //cache: true,
           type: 'POST',
...
$(document).on('click', '[data-toggle-export-erp]', function(e){
  ...
  $.ajax({
           url: '/export/expo	rt/export-data-erp',
           //cache: true,
           type: 'POST',
...
Modal::begin([
  ...
  'headerOptions'=>[
      'style'=> 'border-radius:5px; background-color: rgba(255, 154, 48, 1)',
  ],
]);
Modal::end();
