...
$this->title = Yii::t('app', 'Customers'); 
	...
	*/	
	$aryField= [
		['ID' =>0, 'ATTR' =>['FIELD'=>'TGL','SIZE' => '10px','label'=>'Tgl','align'=>'left']],		  
		['ID' =>1, 'ATTR' =>['FIELD'=>'LAYER_ID','SIZE' => '20px','label'=>'LAYER_ID','align'=>'left']],
		['ID' =>2, 'ATTR' =>['FIELD'=>'CUST_KD','SIZE' => '10px','label'=>'Cust.Id','align'=>'left']],
		['ID' =>3, 'ATTR' =>['FIELD'=>'custNm','SIZE' => '10px','label'=>'Cust.Id','align'=>'left']],
		['ID' =>4, 'ATTR' =>['FIELD'=>'CREATE_BY','SIZE' => '10px','label'=>'Dibuat','align'=>'left']],
		['ID' =>5, 'ATTR' =>['FIELD'=>'CREATE_AT','SIZE' => '10px','label'=>'Tgl.Buat','align'=>'left']],
		['ID' =>6, 'ATTR' =>['FIELD'=>'APPROVED_BY','SIZE' => '10px','label'=>'Disetujui','align'=>'left']],
		['ID' =>7, 'ATTR' =>['FIELD'=>'STATUS','SIZE' => '10px','label'=>'Status','align'=>'left']],
		['ID' =>8, 'ATTR' =>['FIELD'=>'NOTE','SIZE' => '10px','label'=>'Catatan','align'=>'left']],
	];	
	...
	*/	
	...
	$emp_active= GridView::widget([
		'id'=>'active-emp',
		'dataProvider' => $dataProviderLayerMutasi,
		'filterModel' => $searchModellayerMutasi,
		...
		'panel'=>[
			...
			'heading'=>false,
			'type'=>'warning',
			'before'=> Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app', 'Update Layer Mutasi',
									['modelClass' => 'Kategori',]),'#',[
										'data-toggle'=>"modal",
						...
						Html::a('<i class="fa fa-history "></i> '.Yii::t('app', 'Refresh'),
									'/master/customers/esm-index-layermutasi',
									[
									  // 'id'=>'refresh-cust',
