...
/**
 * DraftGeoController implements the CRUD actions for DraftGeo model.
 */
class DraftGeoController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new DraftGeoSearch();
    ...
    /**
     * Displays a single DraftGeo model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing DraftGeo model.
    ...
    /**
     * Deletes an existing DraftGeo model.
