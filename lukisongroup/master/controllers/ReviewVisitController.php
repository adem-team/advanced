	...
	*/
	...
	public function actionDownloadImage()
    {
		...
		if ($model->load(Yii::$app->request->post())) {
			...
			//$log=shell_exec('zip -r /var/www/advanced/lukisongroup/cronjob/temp.zip /var/www/advanced/lukisongroup/cronjob/temp/ 2>&1');
			$log=shell_exec('mkdir /var/www/advanced/lukisongroup/cronjob/SalesMD-2016-09-12');
