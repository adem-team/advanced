...
/**
 * CustomerskatSearch represents the model behind the search form about `lukisongroup\esm\models\Customerskat`.
 */
class CustomerskatSearch extends Customerskat
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['CUST_KD', 'CUST_KD_ALIAS', 'CUST_NM', 'CUST_GRP', 'JOIN_DATE', 'MAP_LAT', 'MAP_LNG', 'PIC', 'ALAMAT', 'EMAIL', 'WEBSITE', 'NOTE', 'NPWP', 'DATA_ALL', 'CAB_ID', 'CORP_ID', 'CREATED_BY', 'CREATED_AT', 'UPDATED_BY', 'UPDATED_AT'], 'safe'],
