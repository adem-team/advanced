...
/**
 * StockRetureSearch represents the model behind the search form about `lukisongroup\purchasing\models\stck\StockReture`.
 */
class StockRetureSearch extends StockReture
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['TGL', 'KD_REF', 'KD_PO', 'KD_SPL', 'KD_DEPT', 'PIC', 'ID_BARANG', 'NM_BARANG', 'UNIT', 'UNIT_NM', 'NOTE', 'CREATE_BY', 'CREATE_AT', 'UPDATE_BY', 'UPDATE_AT'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'KD_REF', $this->KD_REF])
            ->andFilterWhere(['like', 'KD_PO', $this->KD_PO])
