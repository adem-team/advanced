...
/**
 * HeaderDetailSearch represents the model behind the search form about `lukisongroup\purchasing\models\warehouse\HeaderDetail`.
 */
class HeaderDetailSearch extends HeaderDetail
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['ID'], 'integer'],
            [['TGL', 'KD_SJ', 'KD_SO', 'KD_INVOICE', 'KD_FP', 'ETD', 'ETA', 'KD_BARANG', 'NM_BARANG', 'NOTE', 'CREATE_BY', 'CREATE_AT', 'UPDATE_BY', 'UPDATE_AT'], 'safe'],
