	...
	*/
	public function searchHeader($params){
		$soQueryJoin= Yii::$app->db_esm->createCommand("
			SELECT x1.ID as SOT_ID,x9.ID as SO_ID ,x1.TGL,x1.WAKTU_INPUT_INVENTORY,x1.CUST_KD,x1.CUST_NM,x1.KD_BARANG,x1.NM_BARANG,x1.SO_QTY,x1.SO_TYPE,x1.POS,x1.STATUS,x1.ID_GROUP,
	...
	public function searchHeaderInbox($params){
		...
		$soQueryJoin= Yii::$app->db_esm->createCommand("
			SELECT  x1.SOT_ID,x1.SO_ID,x1.KD_SO_HEADER,x1.KD_SO_DETAIL,x1.KODE_REF,x1.TGL as TGL_INBOX,x1.CUST_KD,x1.USER_SIGN1,x1.CREATE_BY,x1.CREATE_AT,x1.STT_PROCESS
					...
					,x6.ISI_MESSAGES
			FROM
				(	SELECT a1.id as SOT_ID, b1.ID as SO_ID,a1.KODE_REF as KD_SO_DETAIL, b1.KD_SO as KD_SO_HEADER,b1.CREATE_BY,b1.CREATE_AT,b1.STT_PROCESS
