			...
			<?php
				...
				*/
				...
				$headColomn=[
					...
					['ID' =>1, 'ATTR' =>['FIELD'=>'KD_REF','SIZE' => '10px','label'=>'PO_REF','align'=>'left','warna'=>'249, 215, 100, 1','GRP'=>false,'FORMAT'=>'html','filter'=>true,'filterType'=>false,'filterwarna'=>'249, 215, 100, 1']],
				...
				// 'ID','TGL','TYPE','KD_REF','KD_PO','KD_SPL','KD_DEPT','PIC','ID_BARANG','NM_BARANG',
				// 'UNIT','UNIT_NM','UNIT_QTY','UNIT_WIGHT','QTY','NOTE:ntext','STATUS','CREATE_BY','CREATE_AT','UPDATE_BY','UPDATE_AT',
				...
				echo GridView::widget([
					...
					'panel' => [
								'heading'=>'<h3 class="panel-title">STOCK RETURE</h3>',
								'type'=>'warning',
								//'showFooter'=>false,
					],
					'toolbar'=> [
