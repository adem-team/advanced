			...
			'columns' => [
					...
					[
						...
						'detail'=>function ($model, $key, $index, $column){
							$aryProviderSoDetailHistory= new ArrayDataProvider([
								'allModels'=>Yii::$app->db_esm->createCommand("
									SELECT x1.ID,x1.TGL,x1.WAKTU_INPUT_INVENTORY,x1.CUST_KD,x1.CUST_NM,x1.KD_BARANG,x1.NM_BARANG,x1.SO_QTY,x1.SO_TYPE,x1.POS,x1.STATUS,x1.ID_GROUP,
										...
										x6.PIC,x6.TLP1,x6.KTP,x6.NPWP,x6.SIUP
					...
					[
						...
						'buttons' => [
							...
							'review' => function ($url, $model) {
							 ...
							 'closed' => function ($url, $model) use ($getPermissionHistoryCheeck){
											if ($getPermissionHistoryCheeck['BTN_VIEW']==0) {
					...
					[
						...
						'hAlign'=>'center',
						'value' => function ($model) {
										return statusProcessSoHistory($model);
						},
						'headerOptions'=>[
							'style'=>[
								'text-align'=>'center',
