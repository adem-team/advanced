			...
			<?php
				...
				*/
				...
				$headColomn=[
					...
					['ID' =>1, 'ATTR' =>['FIELD'=>'KD_DEPT','SIZE' => '10px','label'=>'KD_DEPT','align'=>'left','warna'=>'249, 215, 100, 1','GRP'=>false,'FORMAT'=>'html','filter'=>true,'filterType'=>false,'filterwarna'=>'249, 215, 100, 1']],
				...
				// 'ID','TGL','TYPE','KD_DEPT','PIC','ID_BARANG','NM_BARANG',
