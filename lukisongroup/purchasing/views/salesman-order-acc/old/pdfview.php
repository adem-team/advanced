			 ...
			 <tr>
				...
				<th style="text-align: center; height:20px">
					<div style="margin-left:50px">
						Tangerang, <?php echo tgl2signature($roHeader->SIG1_TGL);  ?>
					</div>
				...
				<th style="text-align: center; height:20px">
					<div style="margin-left:50px">
						Tangerang, <?php echo tgl2signature($roHeader->SIG2_TGL);  ?>
					</div>
				</th>
				<!-- Tanggal PO Approved!-->
				<th style="text-align: center; height:20px">
					<div style="margin-left:50px">
						Tangerang, <?php echo tgl2signature($roHeader->SIG3_TGL);  ?>
					</div>
				</th>
			</tr>
			<!--Keterangan !-->
