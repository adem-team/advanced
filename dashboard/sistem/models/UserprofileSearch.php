...
namespace dashboard\sistem\models;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use dashboard\sistem\models\Userprofile;

/**
 * UserprofileSearch represents the model behind the search form about `dashboard\sistem\models\Userprofile`.
 */
