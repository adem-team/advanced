...
//print_r($aryProviderDataSellIN);
//print_r($aryProviderHeaderSellIN);
	...
	$gvStockSummary = GridView::widget([
		'id'=>'gv-summary-stock',
        'dataProvider' => $aryProviderDataSellIN,
        //'filterModel' => $searchModel,
		//'beforeHeader'=>$getHeaderLabelWrap,
		'showPageSummary' => true,
		'columns' =>$attDinamikSellIN,
		'pjax'=>true,
		'pjaxSettings'=>[
		'options'=>[
...
?>
	<div style="font-family:tahoma, arial, sans-serif;font-size:9pt;text-align:center;color:red"><b>REVIEW - SELL.IN</b></div>
	<?=$gvStockSummary?>