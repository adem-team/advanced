...
Modal::end();
    ...
    'rowOptions'   => function ($model, $key, $index, $grid) {
       return ['id' => $model->id,'onclick' => '$.pjax.reload({
            url: "'.Url::to(['/salesman/schedule-header-crm/index']).'?ScheduleheaderSearch[USER_ID]="+this.id,
		...
		'panel' => [
					...
					'before'=> Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app', 'Add User ',
							['modelClass' => 'Kategori',]),'/salesman/schedule-header-crm/create-user',[
								'data-toggle'=>"modal",
									'data-target'=>"#modal-create",
     ...
     $.fn.modal.Constructor.prototype.enforceFocus = function(){};
       $('#Scheduleheader').on('beforeSubmit',function(){
				 ...
				 if(val == '' && val1 == '')
				 {
					 ...
					 var note = $('#note').val();
					$.ajax({
							url: '/salesman/schedule-header-crm/jsoncalendar_add',
							type: 'POST',
