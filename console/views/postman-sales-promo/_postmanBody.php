			...
			<tbody>
					...
					<td>
						<table style="font-size: 12px; font-family: Verdana, sans-serif;">
							<tr>
								...
								<td style="color:black; background:white;text-align:left">
									Admin, Sales & Marketing Department
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
							...
							<tr>
								...
								<td style="color:black; background:white;text-align:left">
									<?=$valCountStatus['PLANING']<>''?$valCountStatus['PLANING']:'0'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
								...
								<td style="color:black; background:white;text-align:left">
									<?=$valCountStatus['PANDING']<>''?$valCountStatus['PANDING']:'0'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
								...
								<td style="color:black; background:white;text-align:left">
									<?=$valCountStatus['FINISH']<>''?$valCountStatus['FINISH']:'0'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
								...
								<td style="color:black; background:white;text-align:left">
									<?=$valCountStatus['RUNNING']<>''?$valCountStatus['RUNNING']:'0'; ?>
								</td>
							</tr>
							<tr>
								<td style="color:black; background:white;text-align:left">
				...
				<tr>
					<td style="padding: 9px; color:red; background:white;text-align:center">
						This email message has been automatically generated and sent every week, Please do not reply to this message.
					</td>
				</tr>
				<tr>
