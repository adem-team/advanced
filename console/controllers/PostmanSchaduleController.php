...
class PostmanSchaduleController extends Controller
{
	...
	*/
	public function actionExport(){
		...
		$attField1=['USER_ID','MONTH'];
		foreach($attributeField as $key=>$value){
			$attField2[]= $value['TGL'];
			//$attDinamik[]= $value[$key];
		};
		$attFieldAll=array_merge($attField1,$attField2);
		//Row data
		...
		$schaduleGrpData= new ArrayDataProvider([
			...
			//SELECT a.USER_ID,a.SCDL_GROUP AS GRP_ID, b.SCDL_GROUP_NM as GRP_NM,a.CUST_ID,c.CUST_NM,a.LAT,a.LAG 
			'allModels'=>Yii::$app->db_esm->createCommand("				
				SELECT b.SCDL_GROUP_NM as GRP_NM, b.KETERANGAN as GRP_DCRP,a.CUST_ID,c.CUST_NM,a.LAT,a.LAG 
		...
		$excel_content = [
			 ...
			 [
                ...
                'sheet_title' => ['GRP_NM','GRP_DCRP','CUST_ID','CUST_NM','LAT','LAG'], 
